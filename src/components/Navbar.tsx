  ...
  <nav className="w-full flex items-center py-2 absolute top-0 left-0 z-20 text-white" style={{background: 'transparent'}}>
      ...
      <div className="flex-1 justify-center hidden md:flex">
        <ul className="flex gap-8 text-lg font-semibold">
          ...
          <li><a href="/#about-me" className="hover:underline text-white">About Myself</a></li>
        ...
        >
          ...
          >
            ...
            <ul className="flex flex-col gap-8 text-2xl font-semibold mt-8">
              ...
              <li><a href="#about-me" className="hover:underline text-white" onClick={() => setMenuOpen(false)}>About Myself</a></li>
